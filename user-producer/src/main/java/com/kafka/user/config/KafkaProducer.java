...
//    @Qualifier("kafkaTemplate")
    ...
    public ProducerFactory<String, Object> producerFactory() {
        ...
        try {
            if (props.isSslEnable() && StringUtils.isNotBlank(props.getK4aTrustStoreLocation()) && StringUtils.isNotBlank(props.getK4aKeyStoreLocation()) && StringUtils.isNotBlank(credsProperties.getK4aKeyStorePass()) && StringUtils.isNotBlank(credsProperties.getK4aTrustStorePass())){
